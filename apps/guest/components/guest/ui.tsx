...
const ICONS: Record<string, string> = {
  ...
  key: 'M15.5 3a4.5 4.5 0 0 0-4.27 5.94L3.5 16.67V20.5h3.83v-2h2v-2h2l1.73-1.73A4.5 4.5 0 1 0 15.5 3Zm.75 3.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5Z',
  user: 'M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8ZM5.5 20c0-3.6 2.9-6 6.5-6s6.5 2.4 6.5 6',
  wifi: 'M2 8.5a15 15 0 0 1 20 0M5 12a10 10 0 0 1 14 0M8.5 15.5a5.5 5.5 0 0 1 7 0M12 19h.01',
};
